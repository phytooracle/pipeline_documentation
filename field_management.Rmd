...
The following steps must be completed prior to sorghum planting:
  ...
  1. Level the field
  2. Inject subsurface drip irrigation tape
  3. Mark the seed line
  4. Place string, metal spikes and labeled stakes in the field
...
Sorghum planting is done by hand using [Easy-Plant jab hand planters](https://www.johnnyseeds.com/tools-supplies/seeders/jab-planter/easy-plant-jab-type-planter-9178.html?utm_source=google&utm_medium=cpc&utm_campaign=BL%20%7C%20PMax%20%7C%20PRP%20%7C%20HPN%20-%20Smart%20Shopping%20%7C%20All%20Products&gad_source=1&gclid=Cj0KCQiAh8OtBhCQARIsAIkWb6-O2djMwA6ZcjA92P_MQl1rn3f4rC9UEadUIb8rwg2q2QJGVJ-kGGwaAqlGEALw_wcB) (**Figure \@ref(fig:sorghumplantingplot)**). Sorghum seeds must be planted at a depth of 1.25 to 1.5 inches. The planting depth can be set using the adjustable screw at the bottom of the seed planter - ensure this is set to an acceptable depth throughout planting as it can shift.

Planting is carried out by members of the Pauli and Arnold labs. Each person is responsible for carrying seeds, planting the seed in the correct plot, and gently covering the seed with a light amount of soil after planting. It is important that the soil placed on top of the seed not be compacted too much, otherwise seeds will not germinate. Do not step on the seed with your boots!

```{r sorghumplantingplot, echo=FALSE, out.width="60%", out.height="60%", fig.show='hold', fig.align='center', fig.cap="Easy-Plant jab hand planters used for sorghum planting. Photo credit: Johnny's Selected Seeds."}
knitr::include_graphics(c("./images/jabplanter"))
```
