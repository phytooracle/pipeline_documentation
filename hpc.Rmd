...
### Further Information
Further information on the UArizona HPC is available in the [HPC Documentation](https://uarizona.atlassian.net/wiki/spaces/UAHPC/overview).
...
The 2D data collected by the Field Scanner includes stereoTop (RGB), flirIrCamera (thermal), and ps2Top (fluorescence). These data process relatively quickly as they are much lower in size compared to 3-dimensional (3D) data. The processing of 2D data types is fully developed for both lettuce and sorghum (**Figure \@ref(fig:2dprocessingplot)**).
...
PhytoOracle is made up of multiple workflows to process 2D and 3D data (**Figure \@ref(fig:workflowplot)**). These workflows allow for automated, scalable processing of raw data collected by the Field Scanner. The data processing results in high spatial-temporal phenotype information.
...
- [Set up a terminal client](https://emmanuelgonz.github.io/posts/2021/09/terminal-git-irods/)
- [Register for an HPC account](https://uarizona.atlassian.net/wiki/spaces/UAHPC/pages/75990889/Account+Creation)
- [Create a CyVerse account](https://cyverse.org/new%20users)
- [Configure SSH keys](https://github.com/phytooracle/automation/blob/main/docs/dtn.md)

Prior to running any pipelines, the project lead must complete the following:

- [Request access for the user to PI /xdisk/](https://servicenow.arizona.edu/sp) 
- [Grant permissions to directories on CyVerse](https://de.cyverse.org/)
