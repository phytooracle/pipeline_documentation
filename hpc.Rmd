...
```{r dataplot, echo=FALSE, out.width="50%", out.height="50%", fig.show='hold', fig.align='center', fig.cap="Data types collected by the Field Scanner. Two-dimensional (2D) data types include RGB, fluorescence, and thermal images, while three-dimensional (3D) include 3D point clouds."}
...
```{r 3dprocessingplot, echo=FALSE, out.width="80%", out.height="80%", fig.show='hold', fig.align='center', fig.cap="Visualization of 3D data processing by PhytoOracle."}
...
- Generation of test datasets using the test_dataset_automator repository, [click here](https://github.com/phytooracle/test_dataset_automator)
- Transformation selection using the 3d_transformation_selection repository, [click here](https://github.com/phytooracle/3d_transformation_selection)
- Level 01 processing on the UArizona HPC
- Landmark selection using the 3d_landmark_selection repository, [click here](https://github.com/phytooracle/3d_landmark_selection)
